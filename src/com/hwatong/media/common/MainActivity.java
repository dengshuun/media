...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		rl_radio = (RelativeLayout) findViewById(R.id.radio_layout);
		...
		txt_radio = (TextView) findViewById(R.id.txt_radio);
	...
	private void changeToUsb() {
		...
		txt_radio.setText(R.string.txt_music);
		txt_radio.setBackgroundResource(R.drawable.usb_music_selector);
		txt_usb.setText(R.string.txt_video);
		txt_usb.setBackgroundResource(R.drawable.usb_video_selector);
		txt_btmusic.setText(R.string.txt_picture);
		txt_btmusic.setBackgroundResource(R.drawable.usb_picture_selector);
		rl_right.setBackgroundResource(R.drawable.usb_right_bg);
		rl_ipod.setVisibility(View.GONE);
	...
	private void setRadioUnable() {
		rl_radio.setEnabled(false);
		txt_radio.setEnabled(false);
	}
	...
	private void setRadioEnable() {
		rl_radio.setEnabled(true);
		txt_radio.setEnabled(true);
	}
	...
	private void changeToMedia() {
		...
		setBtMusicUnable();
		setIPodUnable();
		txt_radio.setText(R.string.txt_radio);
		txt_radio.setBackgroundResource(R.drawable.radio_icon);
		...
		rl_ipod.setVisibility(View.VISIBLE);
		if (isUsbAvailable) {
			setUsbEnable();
		}
	...
	public void onClick(View v) {
		if (v.getId() == R.id.radio_layout) {
			if (txt_radio.getText().equals(this.getString(R.string.txt_radio))) {
				Intent intent = new Intent();
				intent.setAction("com.hwatong.radio.MAIN");
		...
		} else if (v.getId() == R.id.usb_layout) {
